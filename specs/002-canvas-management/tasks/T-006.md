...
|---------|------|------|------------------|
| 001-auth | backend/auth/dependencies.py | 001-auth/T-015 | `from backend.auth.dependencies import get_current_user, require_role` |
| 001-auth | backend/auth/models.py | 001-auth/T-011 | `from backend.auth.models import User` |
